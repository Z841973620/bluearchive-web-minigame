...
!0;if(("undefined"==typeof d.forceExec||!d.forceExec)&&g.nxlogin){if(null==p){alert("\ub85c\uadf8\uc778 \ud655\uc778\uc911\uc785\ub2c8\ub2e4.");return}if(!p)if(c.execTypeCode!==b.none&&0!==c.atlVersionCode){if(!t&&"589825"!=c.ngmGameCode&&"94224"!=c.ngmGameCode&&"127038"!=c.ngmGameCode){alert("\ub85c\uadf8\uc778 \ud655\uc778\uc911\uc785\ub2c8\ub2e4.");return}if(l.isLogin||"589825"==c.ngmGameCode||"94224"==c.ngmGameCode||"127038"==c.ngmGameCode){if(20===c.atlVersionCode&&l.isMembership&&1===l.mainAuthLevel){NgbMember.RealNameAuth();
return}switch(c.gameGradeCode){case 4:if(l.youth||18>l.age){alert("\uc131\uc778 \uc774\uc6a9\uac00\ub2a5 \uac8c\uc784\uc785\ub2c8\ub2e4.");return}break;case 3:if(15>l.age){alert("15\uc138 \uc774\uc0c1 \uc774\uc6a9\uac00\ub2a5\ud55c \uac8c\uc784\uc785\ub2c8\ub2e4.");return}break;case 2:if(12>l.age){alert("12\uc138 \uc774\uc0c1 \uc774\uc6a9\uac00\ub2a5\ud55c \uac8c\uc784\uc785\ub2c8\ub2e4.");return}}}else{k.showLoginLayer();return}}else if(h.isFunction(d.checkExLogin)&&!d.checkExLogin())return}switch(c.execTypeCode){case 1:m.location.href=
d.url||c.url;break;case 101:d.forceInstall?a.installNGM(c,d):d.restoreInstall?a.manualRestoreNGM(c,d):a.executeNGM(c,d)}h.isFunction(d.afterExecute)&&d.afterExecute()},downloadLauncher:function(b){b=b||{appCode:null,gameCode:null};var d;"undefined"!==typeof b.appCode?d=a.getGameInfoByAppCode(b.appCode):"undefined"!==typeof b.gameCode?d=a.getGameInfoByNgmGameCode(b.gameCode):alert("\uac8c\uc784\uc2dc\uc791 \uc815\ubcf4\uac00 \ubd80\uc871\ud569\ub2c8\ub2e4.");switch(d.execTypeCode){case 1:alert("\ubc14\ub85c \uac8c\uc784\uc124\uce58\uac00 \ubd88\uac00\ub2a5\ud55c \uac8c\uc784\uc785\ub2c8\ub2e4.\n\ud648\ud398\uc774\uc9c0\ub97c \uc774\uc6a9\ud574 \uc8fc\uc138\uc694.");
