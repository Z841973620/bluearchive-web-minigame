...
;storage
       ...
       [endscript]
              ...
              [glink x="240" y="100" width="700" height="25" text="入口大厅" target="&tf.jump1" color="blue" name="glink1" storage="&tf.storage" graphic="choice.png" font_color="0x445160" size="25"]
			  [glink x="240" y="200" width="700" height="25" text="一楼走廊" target="&tf.jump2" color="blue" name="glink2" storage="&tf.storage" graphic="choice.png" font_color="0x445160" size="25"]
              [glink x="240" y="300" width="700" height="25" text="二楼走廊" target="&tf.jump3" color="blue" name="glink3" storage="&tf.storage" graphic="choice.png" font_color="0x445160" size="25"]
              [glink x="240" y="400" width="700" height="25" text="书房" target="&tf.jump4" color="blue" name="glink4" storage="&tf.storage" graphic="choice.png" font_color="0x445160" size="25"]
              [glink x="240" y="500" width="700" height="25" text="主人的卧室" target="&tf.jump5" color="blue" name="glink5" storage="&tf.storage" graphic="choice.png" font_color="0x445160" size="25"]
