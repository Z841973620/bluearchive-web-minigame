...
[macro name="choice_button"]
       ...
       [if exp="tf.mode == '1'"]
              ...
              [glink x="240" y="260" width="720" height="25" text="&tf.choice1" target="&tf.jump1" color="blue" name="glink2" storage="&tf.storage"  font_color="0x445160" graphic="choice.png" size="%size|30"]

              [s]

       [elsif exp="tf.mode == '2'"]
              [glink x="240" y="200" width="720" height="25" text="&tf.choice1" target="&tf.jump1" color="blue" name="glink1" storage="&tf.storage" graphic="choice.png" font_color="0x445160" size="%size1|30"]
              [glink x="240" y="350" width="720" height="25" text="&tf.choice2" target="&tf.jump2" color="blue" name="glink2" storage="&tf.storage" graphic="choice.png" font_color="0x445160" size="%size2|30"]
              [s]

       [elsif exp="tf.mode == '3'"]
              [glink x="240" y="100" width="720" height="25" text="&tf.choice1" target="&tf.jump1" color="blue" name="glink1" storage="&tf.storage" graphic="choice.png" font_color="0x445160" size="%size|30"]
              [glink x="240" y="200" width="720" height="25" text="&tf.choice2" target="&tf.jump2" color="blue" name="glink2" storage="&tf.storage" graphic="choice.png" font_color="0x445160" size="%size|30"]
              [glink x="240" y="300" width="720" height="25" text="&tf.choice3" target="&tf.jump3" color="blue" name="glink3" storage="&tf.storage" graphic="choice.png" font_color="0x445160" size="%size|30"]
